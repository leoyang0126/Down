    ...
    public TestMethod() {
        try {
            DownFileInfoBean bean = new DownFileInfoBean(
                    "http://sw.bos.baidu.com/sw-search-sp/software/e335feb5c2f01/WeChatSetup.exe", "/Users/Documents/temp",
                    "WeChatSetup.exe", CUPNUM*2, true, null);  //http://dlsw.baidu.com/sw-search-sp/soft/a8/27390/androidstudio1.5.0.0.1454148047.exe
